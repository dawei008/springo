...
class ErrorCategory(Enum):
    ...
    VALIDATION = "validation"            # 请求验证错误
    CONTENT = "content"                  # 内容相关错误
...
class ClaudeError:
    ...
    message_zh: str              # 中文错误信息
    message_en: str              # 英文错误信息
    suggestion: str              # 建议操作
...
def should_retry(error: Exception) -> Tuple[bool, int]:
    ...
    Returns:
        Tuple[bool, int]: (是否应该重试, 建议等待时间秒数)
    """
    parsed = parse_error(error)

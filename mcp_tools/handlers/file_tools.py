...
def execute_command(command: str, working_directory: str = None, timeout: int = 300,
                   run_in_background: bool = False, description: str = None) -> Dict[str, Any]:
    """Execute shell command with improved security (timeout: 300s default, 600s for long tasks)"""
